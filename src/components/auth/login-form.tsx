...
import { loginUserApi, AuthError } from "@/client/api/auth";
...
const LoginForm: React.FC = () => {
  ...
  const [loadingType, setLoadingType] = useState<"credentials" | null>(null);
  ...
  return (
    <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col items-center text-center space-y-2">
        ...
        <p className="text-sm text-zinc-500">Enter your credentials to access your admin account.</p>
      </div>
