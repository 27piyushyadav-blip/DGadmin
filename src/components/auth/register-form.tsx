...
import { Eye, EyeOff, Loader2, User, Mail, Lock, ArrowRight, Shield } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="text-2xl font-bold">Join Admin Portal</h1>
        <p className="text-sm text-zinc-500">Create your admin account</p>
      </div>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="admin@example.com" disabled={isLoading} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
