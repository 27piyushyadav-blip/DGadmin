              ...
              <FormItem>
                ...
                <FormControl>
                  <input
                    ...
                    maxLength={6}
                    pattern="[0-9]*"
                    className="flex h-12 w-12 text-lg text-center border border-zinc-200 rounded-md bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-2 disabled:opacity-50"
                    disabled={isLoading}
                    placeholder="0"
                  />
                </FormControl>
